...
The table lists three different eKey figures:

 * Number of patents registered in the patent office of the country

 * Amount of venture capital in 1000 USD
...
tbl_data <- all_data %>% 
    tibble::add_row(europe_mean, .before = 1) %>% 
